                                    ...
                                    children: [
                                      ...
                                      OutlinedButton.icon(
                                        onPressed: () {
                                          ...
                                          if (wishlistModel.isInWishlist(widget.id)) {
                                            wishlistModel.removeFromWishlist(widget.id);
                                          } else {
                                            wishlistModel.addToWishlist(widget.id);
                                          }
                                        },
                                        style: OutlinedButton.styleFrom(
                                            side: const BorderSide(width: 1)
                                        ...
                                        icon: Icon(
                                          wishlistModel.isInWishlist(widget.id)
                                              ? Icons.favorite
